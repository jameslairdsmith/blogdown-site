...
```{r echo=FALSE, fig.cap="Chart 1", fig.subcap = "Fig SubCap", fig.scap= "Fig Scap"}
l <- r2d3(data=rainfall_data, script = "rainfallBars.js")
...
l <- 
  ...
  hc_xAxis(title = list(text = NA), tickInterval=(24 * 3600 * 1000 * 365))
